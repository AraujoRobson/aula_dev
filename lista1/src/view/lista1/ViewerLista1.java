...
import exercicios.Atividade1;
import exercicios.Atividade2;
import exercicios.Atividade3;
import exercicios.Atividade4;
import exercicios.Atividade5;
import exercicios.Atividade6;
import exercicios.Atividade7;
import exercicios.Atividade8;
...
public class ViewerLista1 {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 863, 547);
		...
		panel_2.setBounds(429, 10, 151, 157);
		...
		panel_2_1.setBounds(590, 10, 248, 157);
		...
		panel_1_4.setBounds(429, 177, 409, 157);
		...
		txtBaseAt8.setBounds(112, 45, 126, 28);
		...
		lblExpoente.setBounds(10, 98, 84, 19);
		...
		txtExpoenteAt8.setBounds(112, 96, 126, 28);
		...
		btnAt8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null,String.format("Potência: %.0f", at8.potenciacao(base, expo)));
			}
		});
		btnAt8.setFont(new Font("Comic Sans MS", Font.PLAIN, 12));
		btnAt8.setBounds(273, 47, 126, 70);
		panel_1_4.add(btnAt8);
		
		JButton btnLimpar = new JButton("");
		btnLimpar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Você limpou todos os campos!");
				txtNumAt1.setText(null);
				txtKm.setText(null);
				txtLitros.setText(null);
				txtAnos.setText(null);
				txtPorDia.setText(null);
				txtValor.setText(null);
				txtNum1.setText(null);
				txtNum2.setText(null);
				txtNomeAt5.setText(null);
				txtIdadeAt5.setText(null);
				txtIdadeAt6.setText(null);
				txtBaseAt8.setText(null);
				txtExpoenteAt8.setText(null);
				lblAnosAt7.setText(null);
			}
		});
		btnLimpar.setIcon(new ImageIcon(ViewerLista1.class.getResource("/imgs/broom-win11-color.png")));
		btnLimpar.setFont(new Font("Comic Sans MS", Font.PLAIN, 12));
		btnLimpar.setBounds(429, 344, 199, 157);
		...
		btnSair.setIcon(new ImageIcon(ViewerLista1.class.getResource("/imgs/exit-win11-color.png")));
		btnSair.setFont(new Font("Comic Sans MS", Font.PLAIN, 12));
		btnSair.setBounds(638, 344, 200, 157);
